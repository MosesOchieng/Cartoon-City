...
<div class="job">
 <div class="header">
  ...
  <div class="user-settings">
   ...
   <div class="user-name">Moses Ochieng</div>
  </div>
 </div>
 <div class="wrapper">
  <div class="search-menu">
   <div class="search-bar">
    ...
    <div class="search item">Electrical repair.
    ...
    <div class="search item">Carpenter
     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x">
      <path d="M18 6L6 18M6 6l12 12" /></svg>
    </div>
   </div>
  ...
  <div class="main-container">
    ...
    <div class="job-time">
     ...
     <div class="job-wrapper">
      <div class="type-container">
       ...
       <label for="job1">Ksh.700 - Ksh.1000</label>
       <span class="job-number">9</span>
      </div>
      <div class="type-container">
       <input type="checkbox" id="job2" class="job-style">
       <label for="job2">Ksh.1000 - Ksh.1200</label>
       <span class="job-number">67</span>
      </div>
      <div class="type-container">
       <input type="checkbox" id="job3" class="job-style">
       <label for="job3">Ksh.1200 - Ksh.1400</label>
       <span class="job-number">24</span>
      </div>
      <div class="type-container">
       <input type="checkbox" id="job4" class="job-style">
       <label for="job4">Ksh.1500 - Ksh.1800</label>
   ...
   <div class="searched-jobs">
    <div class="searched-bar">
     <div class="searched-show">Showing 12 Jobs</div>
     <div class="searched-sort">Sort by: <span class="post-time">Newest Post </span><span class="menu-icon">▼</span></div>
    </div>
    <div class="job-cards">
     <div class="job-card">
      <div class="job-card-header">
       <svg viewBox="0 -13 512 512" xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" style="background-color:#2e2882">
        <g fill="#feb0a5">
      ...
      <div class="job-card-title">Carpenter</div>
      <div class="job-card-subtitle">
       Need a Carpenter asap to fix my table and stools
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Place</button>
       <button class="search-buttons detail-button">Wages</button>
       <button class="search-buttons detail-button">Contact</button>
      </div>
     ...
     <div class="job-card">
      ...
      <div class="job-card-title">Plumber</div>
      <div class="job-card-subtitle">
    Need a quick fix for my pipes and household water line systems.
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Place</button>
       <button class="search-buttons detail-button">Wages</button>
     ...
     <div class="job-card">
      <div class="job-card-header">
       <svg xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" viewBox="0 0 512 512" fill="#fff" style="background-color:#55acee">
      ...
      <div class="job-card-title">Electrical repairs.</div>
      <div class="job-card-subtitle">
       Need someone to repair my television . Pangani Business center.
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Place</button>
       <button class="search-buttons detail-button">Wages</button>
     ...
     <div class="job-card">
      <div class="job-card-header">
       <svg viewBox="0 0 24 24" xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" fill="#fff" style="background-color:#1e1f26">
      ...
      <div class="job-card-title">Mechanics</div>
      <div class="job-card-subtitle">
       Need a tire fix .Available at Voi road.Flat tire is the problem.
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Place</button>
       <button class="search-buttons detail-button">Wages</button>
     ...
     <div class="job-card">
      <div class="job-card-header">
       <svg viewBox="0 0 24 24" xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" style="background-color:#ffe80f">
      ...
      <div class="job-card-title">Househelp</div>
      <div class="job-card-subtitle">
       Need a house cleaner at Lavington.Duties include general house cleaning and chores around the house.
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Place</button>
       <button class="search-buttons detail-button">Wages</button>
     ...
     <div class="job-card">
      <div class="job-card-header">
       <svg viewBox="0 0 24 24" xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" style="background-color: #fe5b5f">
      ...
      <div class="job-card-title">Farm manager</div>
      <div class="job-card-subtitle">
       Natafuta mfanyikazi wa shamba yangu.Kama anaeza linda ngombe ama mbuzi ama kuku.Mfanyikazi huyu lazima awe na uwezo wa miaka tatu.
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Place</button>
       <button class="search-buttons detail-button">Wages</button>
     ...
     <div class="job-card">
      <div class="job-card-header">
       <svg viewBox="0 0 24 24" xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" style="background-color: #5c6bc0">
        <g fill="#fff">
      ...
      <div class="job-card-title">Fundi wa nguo</div>
      <div class="job-card-subtitle">
       Fundi wa nguo anaye weza kushona mavazi ya kisasa .Mwenye tajriba ya juu anatakikana.
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Place</button>
       <button class="search-buttons detail-button">Wages</button>
     ...
     <div class="job-card">
      <div class="job-card-header">
       <svg viewBox="0 0 24 24" xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" fill="#fff" style="background-color:#ea4c88">
      ...
      <div class="job-card-title">Metal work and Welding</div>
      <div class="job-card-subtitle">
       Natafuta msee wa kuunda masunduku , anishow shop tuongee bei ya kuunda moja.
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Places</button>
       <button class="search-buttons detail-button">Wages</button>
       <button class="search-buttons detail-button">Contact</button>
      </div>
      <div class="job-card-buttons">
     ...
     <div class="job-card">
      <div class="job-card-header">
       <svg xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" viewBox="0 0 512 512">
      ...
      <div class="job-card-title">Building repairs</div>
      <div class="job-card-subtitle">
       Looking for an expirienced mason with skills in construction
      </div>
      <div class="job-detail-buttons">
       <button class="search-buttons detail-button">Place</button>
       <button class="search-buttons detail-button">Wages</button>
       <button class="search-buttons detail-button">Contacts</button>
      </div>
      <div class="job-card-buttons">
       <button class="search-buttons card-buttons">Apply Now</button>
       <button class="search-buttons card-buttons-msg">Messages</button>
    ...
    <div class="job-overview">
      ...
      <div class="job-overview-card">
       <div class="job-card overview-card">
        ...
        Pangani Street.
         ...
         <svg class="heart" xmlns="https://www.canva.com/design/DAFTbm6TfL0/WWdxOHdJQio2nduUKrCoGA/edit?utm_content=DAFTbm6TfL0&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
        ...
        <div class="job-overview-buttons">
         <div class="search-buttons time-button">Contacts</div>
         <div class="search-buttons level-button">Wages</div>
         <div class="job-stat">New</div>
         <div class="job-day">3 minutes</div>
        </div>
       </div>
      </div>
      <div class="job-overview-card">
       <div class="job-card overview-card">
        ...
        <div class="job-overview-buttons">
         <div class="search-buttons time-button">Contacts</div>
         <div class="search-buttons level-button">Wage</div>
         <div class="job-stat">New</div>
         <div class="job-day">1 minute</div>
        </div>
       </div>
      </div>
      <div class="job-overview-card">
       <div class="job-card overview-card">
        ...
        <path d="M512 97.2c-19 8.4-39.3 14-60.5 16.6 21.8-13 38.4-33.4 46.2-58a209.8 209.8 0 01-66.6 25.4A105 105 0 00249.5 153c0 8.3.8 16.3 2.5 24A297.1 297.1 0 0135.6 67 105.1 105.1 0 0068 207.4c-16.9-.3-33.4-5.2-47.4-12.9v1.1c0 51 36.4 93.4 84 103.2-8.5 2.3-17.8 3.4-27.4 3.4-6.8 0-13.5-.3-20-1.8a106 106 0 0098.2 73.2A211 211 0 010 416.9 295.5 295.5 0 00161 464c193.2 0 298.8-160 298.8-298.7 0-4.6-.2-9.1-.4-13.6A209.4 209.4 0 00512 97.2z" /></svg>
         <div class="overview-detail">
          <div class="job-card-title">Electric repairs</div>
          <div class="job-card-subtitle">
        Huruma .
          </div>
         </div>
      ...
      <div class="job-overview-card">
       <div class="job-card overview-card">
        ...
        <path d="M12 20.6c-1.4 1.5-3.1 3-5.1 3.3-2 .8-5.9-1.3-5.9-5 0-2.5 3.2-8 6.6-15.1C8.5 1.9 9.4 0 12 0c2.6 0 3.5 1.8 4.6 4C23 17 23 17.7 23 19c0 4.4-5.5 8-11 1.7zm9.5-1.7c0-2-6.4-14.4-6.5-14.5-.9-1.9-1.4-2.9-3-2.9-1.8 0-2.3 1.5-3.2 3.2C2.5 17.2 2.5 18 2.5 19c0 3 3.7 6 8.5.6-2-2.6-3-4.8-3-6.6 0-2.7 2-4.2 4-4.2s4 1.5 4 4.2c0 1.8-1 4-3 6.6 4.6 5.2 8.5 2.5 8.5-.6zM12 10.2c-1.2 0-2.5.9-2.5 2.7 0 1.4.9 3.3 2.5 5.4 1.6-2.1 2.5-4 2.5-5.4 0-1.8-1.3-2.7-2.5-2.7z" fill="#fff" /></svg>
         ...
         <svg class="heart" xmlns="#" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
          <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" /></svg>
        </div>
        <div class="job-overview-buttons">
         <div class="search-buttons time-button">Contact</div>
         <div class="search-buttons level-button">Wages</div>
         <div class="job-stat">New</div>
         <div class="job-day">2 minutes.</div>
        </div>
       </div>
      </div>
      <div class="job-overview-card">
       <div class="job-card overview-card">
        <div class="overview-wrapper">
         <svg viewBox="0 0 24 24" xmlns="#"style="background-color: #5c6bc0">
        <g fill="#fff">
         <path d="M3.6 21.2h14.2l-.6-2.2 5.8 5V2.5C23 1 21.8 0 20.4 0H3.6A2.6 2.6 0 001 2.5v16.2c0 1.4 1.2 2.5 2.6 2.5zM14 5.7zM6.5 7C8.3 5.6 10 5.7 10 5.7l.2.1c-2.3.6-3.3 1.6-3.3 1.6.1 0 4.6-2.7 10.1 0 0 0-1-1-3.1-1.5l.2-.2c.3 0 1.8 0 3.5 1.3 0 0 1.8 3.1 1.8 7 0 0-1.1 1.6-4 1.7l-.7-1a4 4 0 002.2-1.4c-3.2 2-6 1.7-9.3.3h-.1l-.4-.2s.6 1 2.2 1.4l-.8 1c-2.8 0-3.8-1.8-3.8-1.8 0-3.9 1.8-7 1.8-7z" />
         <path d="M14.3 12.8c.7 0 1.3-.6 1.3-1.4 0-.7-.6-1.3-1.3-1.3a1.3 1.3 0 000 2.7zM9.7 12.8c.7 0 1.3-.6 1.3-1.4 0-.7-.6-1.3-1.3-1.3a1.3 1.3 0 000 2.7z" />
        </g>
       ...
       <div class="job-card overview-card">
        <div class="overview-wrapper">
          <svg viewBox="0 0 24 24" xmlns="#" fill="#fff" style="background-color:#ea4c88">
        <path d="M16.4 23.2C28.6 18.2 25.2 0 12 0a12 12 0 104.4 23.2zM5.3 20c.8-1.5 3.6-5.5 8.3-7 1 2.6 1.7 5.5 1.7 8.8-3.5 1.2-7.3.4-10-1.8zm11.5 1.2a27 27 0 00-1.7-8.4c2-.4 4.5-.2 7.2 1-.6 3.2-2.6 6-5.5 7.4zm5.7-9c-3-1.1-5.7-1.3-8-.8a28 28 0 00-1.1-2.3 20 20 0 006.5-4c1.7 1.9 2.7 4.3 2.6 7zM18.9 4c-.9.8-2.9 2.4-6.3 3.8A28 28 0 008 2.3C11.6.8 15.8 1.4 19 4zM6.6 3c.8.7 2.7 2.5 4.5 5.3a33 33 0 01-9.4 1.5c.6-3 2.4-5.4 4.9-6.9zm-5 8.3c4.2-.1 7.6-.8 10.3-1.7l1.1 2.1A17.4 17.4 0 004.2 19c-1.8-2-2.8-4.7-2.7-7.6z" /></svg>
         <div class="overview-detail">
          <div class="job-card-title">Metal works and welding</div>
          <div class="job-card-subtitle">
        Kariobangi South.
          </div>
         </div>
        ...
        <div class="job-overview-buttons">
         ...
         <div class="search-buttons level-button">Wages</div>
         <div class="job-stat">New</div>
         <div class="job-day">10 minutes</div>
        </div>
       </div>
      </div>
      <div class="job-overview-card">
       <div class="job-card overview-card">
        ...
        <path d="M419.4 59l-83 67.8A152.3 152.3 0 00112 206.5l-83.4-68.2a256 256 0 01390.8-79.4z" fill="#f14336" /></svg>
         <div class="overview-detail">
          <div class="job-card-title">Mason</div>
          <div class="job-card-subtitle">
          Kileleshwa , Nairobi.
          </div>
         </div>
        ...
        <div class="job-overview-buttons">
         ...
         <div class="search-buttons level-button">Wages</div>
         <div class="job-stat">New</div>
         <div class="job-day">41 minutes</div>
        </div>
       </div>
      </div>
     </div>
     <div class="job-explain">
      ...
      <div class="job-logos">
       <svg xmlns="#" viewBox="0 0 32 32" style="background-color:#f76754">
        <path xmlns="#" d="M0 .5h4.2v23H0z" fill="#042b48" data-original="#212121"></path>
        <path xmlns="#" d="M15.4.5a8.6 8.6 0 100 17.2 8.6 8.6 0 000-17.2z" fill="#fefefe" data-original="#f4511e"></path></svg>
      </div>
      <div class="job-explain-content">
      <div class="job-title-wrapper">
       <div class="job-card-title">Mason and builder</div>
       <div class="job-action">
        <svg class="heart" xmlns="#" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
          <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" /></svg>
        <svg xmlns="#" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-share-2"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="M8.6 13.5l6.8 4M15.4 6.5l-6.8 4"/></svg>
       </div>
       </div>
       <div class="job-subtitle-wrapper">
        <div class="company-name">Kinyanjui John <span class="comp-location">Londaini , Nairobi</span></div>
        <div class="posted">Posted 8 minutes ago<span class="app-number">8 Applications</span></div>
       </div>
       <div class="explain-bar">
        ...
        <div class="explain-contents">
        <div class="explain-title">Place</div>
        <div class="explain-subtitle">Kariobangi ,Nairobi</div>
         </div>
        <div class="explain-contents">
        ...
        <div class="explain-subtitle">Ksh. 2150</div>
         </div>
       </div>
       <div class="overview-text">
        <div class="overview-text-header">Overview</div>
        <div class="overview-text-subheader">Find a Jua Kali artisan of your choice.</div>
       </div>
       <div class="overview-text">
