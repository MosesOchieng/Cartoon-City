...
if($text == ""){
    ...
    $response1 = "1. Log$response = "Welcome to Plan B choose options to proceed. /n";
    $response1 = "1. Login account /n";
    $responses = "2. Change Password.";in account /n";
    $responses = "2. Change Password.";
    ...
    $responses = "1.Enter your number to verify your account.";
    $responses = "2.Back";
}else if($text == "1*1"){
