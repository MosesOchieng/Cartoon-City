...
def ussd():
  ...
  if text      == '':
      ...
      response += "Masons. \n"
      response += "Fisher. \n"
      response += "Shoe repairs. \n"
      response += "Motorbike. \n"
      response += "Hawkers."
  elif text == '2*1'      response = "CON Dear user enter your full name,followed by a dot ,your identification number,then your profession to register."
  elif text == '1*1*1':
      response = "END Dear user the following are a list of Jua Kali Artisans with that skill."+"Closest to you "
      #define the variable from test net to locate.
  elif text == '2*1*1':
      response 
