                                ...
                                <form action="captcha.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                <div class="input-group-prepend">
                                                    <span class=<div class="input-group-prepend">
                                                    <span class="input-group-text"><span class="fas fa-unlock-alt"></span><?php if (isset($password_error)) echo $password_error; ?></span>
                                                <div class="input-group-text"><span class="fas fa-unlock-alt"></span><?php if (isset($password_error)) echo $password_error; ?></span>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                               ...
                                               <input class="form-control" id="exampleInputPassword7"  placeholder="confirm password" type="password"><span class="input-group-text"><span class="fas fa-unlock-alt"></span><?php if (isset($cpassword_error)) echo $cpassword_error; ?></span>
</div>  
                                            </div>
                                        </div>
                                        <!-- End of Form -->
