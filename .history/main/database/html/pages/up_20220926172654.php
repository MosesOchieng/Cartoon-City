                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
        <input class="form-control" id="exampleInputPassword7" name="cppassword"                                   <span class="input-group-text"><span class="fas fa-unlock-alt"></span><?php if (isset($cpassword_error)) echo $cpassword_error; ?></span>
</div>  
                                            </div>
                                        </div>
                                        <!-- End of Form -->
