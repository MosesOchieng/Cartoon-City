                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="cppass"id="exampleConfirmPassword7" placeholder="Confirm password" type="password" name="confpassword" aria-label="Password" required>
                                            </div>
                                        </div>
                                        <!-- End of Form -->
                                        ...
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="checkbox" value="" id="defaultCheck3" name="free">
                                            <label class="form-check-label" for="defaultCheck3" >
                                                Free Lancer<a href="#"></a>
                                            </label>
                                        </div>
                                        <div class="form-check mb-4">
                                            <input class="form-check-input" type="checkbox" value="" id="defaultCheck4" name="juakali">
