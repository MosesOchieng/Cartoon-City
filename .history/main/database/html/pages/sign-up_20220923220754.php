...
$email = mysqli_real_escape_string($conn, $_POST['exampleInputIcon4']);

$password = mysqli_real_escape_string($conn, $_POST['exampleInputPassword7']);
                        ...
                        <div class="card bg-primary shadow-soft border-light p-4">
                            ...
                            <div class="card-body">
                                <form action="captcha.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><span class="fas fa-unlock-alt"></span><?php if (isset($cpassword_error)) echo $cpassword_error; ?></span>
                                                </div>
                                                <input class="form-control" id="cppass"id="exampleConfirmPassword7" placeholder="Confirm password" type="password" name="confpassword" aria-label="Password" required>
                                            </div>
                                        </div>
                                        <!-- End of Form -->
                                    ...
                                    <button type="submit" class="btn btn-block btn-primary" id="submit">Sign up</button>
                                </form>
