...
$password = mysqli_real_escape_string($conn, $_G['password']);
...
mysqli_query($conn, "INSERT INTO planBdb(email ,conf pass, pass) VALUES('" . $_POST['email'] . "', '" . md5($_POST['cppass']). "', '" . md5($_POST['password']) . "')");
echo "User registration form with captcha validation has been successfully saved";
}
if(isset($_POST['submit'])){
    $employment=['client','juakali','freelancer'];
