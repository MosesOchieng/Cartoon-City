...
Backend ;PHP,(collecting and validating forms data,sending data to the lampp database)PHP COOKIES ,PHP GOOGLE RECAPTCHA, (PHPMAILER)for sending email verification links to , Python;(Libraries - Beautiful soap, requests, url ) for
