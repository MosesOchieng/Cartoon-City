...
Backend ;PHP,(collecting and validating forms data,sending data to the lampp database)PHP COOKIES ,, (PHPMAILER), Python;(Libraries - Beautiful soap, requests, url ) for
